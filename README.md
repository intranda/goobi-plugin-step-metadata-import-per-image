# Goobi workflow Plugin: goobi-plugin-step-metadata-import-per-image
...
This Step plugin for Goobi workflow allows the import of structure and metadata from an Excel file listing all images.
